...
Console.WriteLine($"Минимальное число массива равно: {min}, расположено на {minj} строке, в {mini} столбце");
        Console.WriteLine($"Максимальное число массива равно: {max}, расположено на {maxj} строке, в {maxi} столбце");
}
